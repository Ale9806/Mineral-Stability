...
plot_minerals_rxns_ABCDE_anim <- ABCDE %>%
  ...
  layout(title = "Concentrations",
         ...
         yaxis = list(title = "Micromoles mineral in system", range = c(0, 50))) # plotly::TeX("\\text{moles mineral in system}"




subplot(plot_reactions_ABCDE_anim, plot_minerals_rxns_ABCDE_anim, nrows = 1, titleX = T, titleY = T) %>% layout(showlegend = FALSE) %>% 
