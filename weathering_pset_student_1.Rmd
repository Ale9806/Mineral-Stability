...
We can relate these equations to their equilibrium constants through the law of mass action, i.e. for reaction 1:
...
Now let's see what happens if we try to add another equilibrium line to the diagram.
